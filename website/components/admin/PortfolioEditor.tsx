          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5">
            {existingImages.map((image, index) => (
              <div key={`${image}-${index}`} className="relative aspect-square overflow-hidden rounded-xl border border-gray-200">
                <Image src={image} alt={`Existing portfolio ${index + 1}`} fill className="object-cover" sizes="(min-width: 1024px) 20vw, (min-width: 768px) 33vw, 50vw" />
            ...
            {newImagePreviews.map((image, index) => (
              <div key={`${image}-${index}`} className="relative aspect-square overflow-hidden rounded-xl border border-gray-200">
                <Image src={image} alt={`New portfolio ${index + 1}`} fill className="object-cover" sizes="(min-width: 1024px) 20vw, (min-width: 768px) 33vw, 50vw" />
